...
class TestOptimizationResult(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """
        Test that OptimizationResult is a
    ...
    def test_problem_id_attr(self):
        """
        Test that OptimizationResult
        has attribute problem_id, and it's None
        """
        opti_result = OptimizationResult()
    ...
    def test_users_id_attr(self):
        """
        Test that OptimizationResult has
        attribute users_id, and it's None
        """
        opti_result = OptimizationResult()
    ...
    def test_opti_front_obj2_attr(self):
        """
        Test that OptimizationResult has attribute
        opti_front_obj2, and it's an empty list
        """
        opti_result = OptimizationResult()
    ...
    def test_opti_front_obj3_attr(self):
        """
        Test that OptimizationResult has
        attribute opti_front_obj3, and it's None
        """
        opti_result = OptimizationResult()
    ...
    def test_opti_para_attr(self):
        """
        Test that OptimizationResult has
        attribute opti_para, and it's an empty list
        """
        opti_result = OptimizationResult()
...
class TestOptimizationResultDocs(unittest.TestCase):
    ...
    of OptimizationResult class
    """
    @classmethod
    def setUpClass(cls):
        """Set up for the doc tests"""
        cls.opti_result_f = inspect.getmembers(
            OptimizationResult, inspect.isfunction)

    def test_pep8_conformance_optimizationresult(self):
        """
        Test that models/optimizationresult.py
        conforms to PEP8.
        """
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(
            ['models/optimizationresult.py'])
        self.assertEqual(result.total_errors, 0,
                         "Found code style errors (and warnings).")

    def test_pep8_conformance_test_optimizationresult(self):
        """
        Test that tests/test_models/test_optimizationresult.py
        conforms to PEP8.
        """
        pep8s = pep8.StyleGuide(quiet=True)
        result = pep8s.check_files(
            ['tests/test_models/test_optimizationresult.py'])
        self.assertEqual(result.total_errors, 0,
                         "Found code style errors (and warnings).")
