...
def nsga2(table_data, table_data1, table_data2, task_id, test_mode=False):
    ...
    for zz in range(iteration):
        ...
        def fronting(pop_size,fitnessvalue ,fitnessvalue1): #### DOMINANT DEPTH METHOD
            """ this function computes fronts of the solutions"""
            Fs = []
    ...
    ################## END OF (FAST NON DOMINATED SORTING) THIS HELPS I CONVERGANCE OF THE SOLUTION ###############################
        ...
        def cdist(fronts, pop_size, fff):
            """ the crowd distance computation to avoid solution clustering """
        ...
        def crossover(pp, crossover_rate):
            """ croosover function exsures exploration of the search space """
        ...
        def mutation(nin, mutation_rate):
            """ the mutation function ensures exploitation of search space """
            deltax = []
            u1 = []
            Oms = []
...
def nsgaa2(table_data, table_data1, table_data2, task_id):
    ...
    for zz in range(iteration):
        ...
        def fronting(pop_size,fitnessvalue ,fitnessvalue1, fitnessvalue2): #### DOMINANT DEPTH METHOD
            """
            classify solution into different front base on their fitness values
